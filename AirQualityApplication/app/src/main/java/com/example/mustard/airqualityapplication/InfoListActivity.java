 ...
 * {@link InfoListFragment} and the item details
 * (if present) is a {@link InfoDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link InfoListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class InfoListActivity extends Activity
        implements InfoListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.info_detail_container) != null) {
            ...
            ((InfoListFragment) getFragmentManager()
                    .findFragmentById(R.id.info_list))
    ...
    /**
     * Callback method from {@link InfoListFragment.Callbacks}

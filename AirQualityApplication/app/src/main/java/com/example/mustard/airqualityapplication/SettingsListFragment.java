 ...
 * currently being viewed in a {@link SettingsDetailFragment}.
 * <p>
...
public class SettingsListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<SettingsContent.SettingsItem>(
                getActivity(),
                android.R.layout.simple_list_item_activated_1,
                android.R.id.text1,
                SettingsContent.ITEMS));
    }
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(SettingsContent.ITEMS.get(position).id);
    }
